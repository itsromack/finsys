...
<header class="main-header">
  ...
  <a href="{{ route('admin_dashboard') }}" class="logo">
    ...
    <span class="logo-lg"><b>Knight</b>Corp</span>
  </a>
  <!-- Header Navbar -->
      ...
      @if (!true)
        ...
        <li class="dropdown user user-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <img src="/images/img_user_placeholder.png" class="user-image" alt="User Image">
        ...
        <li>
          <form action="/logout" method="POST">
            {{ csrf_field() }}
            <button class="btn btn-default btn-logout"><i class="fa fa-sign-out"></i> Logout</button>
          </form>
        </li>
      </ul>
    </div>
